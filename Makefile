...
suvackm:suvackm.cpp anulekh.h
	$(CXX) suvackm.cpp -o suvackm
suvackm.js:suvackm.cpp anulekh.h
	em++ -Wcast-align -Wover-aligned -O2 suvackm.cpp -s EXPORTED_FUNCTIONS='["_anulekh","_main"]' -s EXPORTED_RUNTIME_METHODS='["ccall"]' -o suvackm.js -s SAFE_HEAP=1 -s WARN_UNALIGNED=1
1:1.cpp
