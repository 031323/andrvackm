...
public:
	...
	void वाचनम्()
	{
		...
		*/
		...
		{{अत्,"a"}, {आत्,"a:"}, {इत्,"i"}, {ईत्,"i:"}, {उत्,"u"}, {ऊत्,"u:"}, {ऋत्,"r"}, {ॠत्,"r"}, {ऌत्,"l"}, {ॡत्,"l"}, {एत्,"e:"}, {ऐत्,"ai"}, {ओत्,"u"}, {औत्,"au"}, {कः,"k"}, {खः,"kh"}, {गः,"g"}, {घः,"gh"}, {ङः,"n~"}, {चः,"c"}, {छः,"ch"}, {जः,"j"}, {झः,"jh"}, {ञः,"N~"}, {टः,"T"}, {ठः,"Th"}, {डः,"D"}, {ढः,"Dh"}, {णः,"N"}, {तः,"t"}, {थः,"th"}, {दः,"d"}, {धः,"dh"}, {नः,"n"}, {पः,"p"}, {फः,"ph"}, {बः,"b"}, {भः,"bh"}, {मः,"m"}, {यः,"y"}, {रः,"r"}, {लः,"l"}, {वः,"v"}, {शः,"s\'"}, {षः,"S"}, {सः,"s"}, {हः,"h"}, {विसर्गः,"h"}, {अनुस्वारः,"m"}, {लँः,"n"}}};
