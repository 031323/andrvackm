...
public:
	...
	void वाचनम्()
	{
		...
		*/
		...
		if(देशः==0)
		{
			std::vector<std::string> भागाः;
			उत्पत्तिः+=उपस्थितः<1?"_ ":अङ्कनम्[उपस्थितः]+" ";
			int अवधिः=(अधिकारः(उपस्थितः,दीर्घः)?200:अधिकारः(उपस्थितः,ह्रस्वः)?100:उपस्थितः==0?200:उपस्थितः==-1?30:अधिकारः(उपस्थितः,उष्मा)?150:60);
			...
			भागाः[0]+=" 0 "+(पूर्वस्वरः==2?उदात्तस्य:अनुदात्तस्य);			
			if(पूर्वस्वरः==2&&स्वरः_==0&&अधिकारः(उपस्थितः,स्वरः))
			{
				भागाः[(उपस्थितः==ऋत्||उपस्थितः==ॠत्)?1:0]+=std::string(" ")+(अधिकारः(उपस्थितः,दीर्घः)?"30":"60")+" "+अनुदात्तस्य;
			}
			भागाः.back()+=" 100 "+(स्वरः_==2?उदात्तस्य:अनुदात्तस्य);
			
			for(auto क्रमः=भागाः.begin();क्रमः!=भागाः.end();++क्रमः)
				उत्पत्तिः+=*क्रमः+"\n";
		}
		else
		{
			उत्पत्तिः+=(उपस्थितः<1?"_":उपस्थितः==ञः&&अधिकारः(पश्चिमः,स्वरः)?"n":अङ्कनम्[उपस्थितः])+" ";
			int अवधिः;
			//अवधिः=(अधिकारः(उपस्थितः,दीर्घः)?200:अधिकारः(उपस्थितः,ह्रस्वः)?100:उपस्थितः==0?200:उपस्थितः==-1?30:अधिकारः(उपस्थितः,उष्मा)?150:60);
			//if((अधिकारः(उपस्थितः,उष्मा)||अधिकारः(उपस्थितः,अन्तःस्थः)||अधिकारः(उपस्थितः,नासिक्यः)||उपस्थितः==विसर्गः)&&अधिकारः(पश्चिमः,व्यञ्जनः))अवधिः=150;
			//if((अधिकारः(उपस्थितः,खरः)||अधिकारः(उपस्थितः,अतिखरः)||अधिकारः(उपस्थितः,मृदुः)||अधिकारः(उपस्थितः,घोषः))&&अधिकारः(पश्चिमः,व्यञ्जनः))अवधिः=150;
			
			//if((अधिकारः(उपस्थितः,खरः)||अधिकारः(उपस्थितः,अतिखरः))&&(अधिकारः(पश्चिमः,खरः)||अधिकारः(पश्चिमः,अतिखरः))){अवधिः=10;}
				//if((अधिकारः(उपस्थितः,खरः)||अधिकारः(उपस्थितः,अतिखरः))&&(अधिकारः(पूर्वः,खरः)||अधिकारः(पूर्वः,अतिखरः)))अवधिः=250;
			
			//if(अधिकारः(उपस्थितः,खरः)&&अधिकारः(पश्चिमः,वर्गीयः))अवधिः=20;
			अवधिः=उपस्थितः==ओत्?250:उपस्थितः==-1?10:101;
			उत्पत्तिः+=std::to_string(अवधिः)+" ";
			if(पूर्वस्वरः==2&&स्वरः_==0)उत्पत्तिः+="0 "+उदात्तस्य+" "+
			//+"50"
			...
			//if(अधिकारः(उपस्थितः,खरः)&&अधिकारः(पश्चिमः,वर्गीयः))उत्पत्तिः+="_ 60\n";
				...
				//if((अधिकारः(उपस्थितः,खरः)||अधिकारः(उपस्थितः,अतिखरः))&&(अधिकारः(पश्चिमः,खरः)||अधिकारः(पश्चिमः,अतिखरः))){उत्पत्तिः+="_ 120\n";}
				if(उपस्थितः==तः&&पश्चिमः==पः)उत्पत्तिः+="t 101\n";
				if(उपस्थितः==ॠत्)उत्पत्तिः+="r 101\n";
				if(उपस्थितः==मः&&पश्चिमः==0)उत्पत्तिः+="m 101\n";
				if(उपस्थितः==ङः&&पश्चिमः==मः)उत्पत्तिः+="g 10\n";
				if(उपस्थितः==हः&&पश्चिमः==मः)उत्पत्तिः+="_ 10\n";
				if(उपस्थितः==विसर्गः&&पश्चिमः==0)उत्पत्तिः+="N~ 10\n";
				//if(उपस्थितः==ओत्)उत्पत्तिः+=std::string("_ 10\no 100 100 ")+(स्वरः_==2?उदात्तस्य:अनुदात्तस्य)+"\n ";
				//if(उपस्थितः==ञः&&!अधिकारः(पश्चिमः,चवर्गीयः))उत्पत्तिः+="_ 10\ny 10\n";
